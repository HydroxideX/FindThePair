...
function start (row,col) {
  ...
  images[0] = "Resources/cat.jpg";
  images[1] = "Resources/coala.jpg";
  images[2] = "Resources/dog.jpg";
  images[3] = "Resources/fox.jpg";
  images[4] = "Resources/frog.jpg";
  images[5] = "Resources/gorilla.jpg";
  images[6] = "Resources/hawk.jpg";
  images[7] = "Resources/lamp.jpg";
  images[8] = "Resources/parrot.jpg";
  images[9] = "Resources/rabbit.jpg";
	ct = 0;
...
function resize() {
  ...
  document.body.style.background = 'url(https://images.unsplash.com/photo-1523878288860-7ad281611901?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=751&q=80)';
...
function view() {
	...
	for(var i = 0;i<row;i++) {
      ...
      document.getElementById(currentImage).src = name;
		}
	}
...
function change(x,y){
	...
	if (solved[x][y] == 0) {
		...
		document.getElementById(imageID).src = name;
...
function gameOver(){
  document.body.style.background = 'url(https://images.unsplash.com/photo-1469474968028-56623f02e42e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=753&q=80)';
  document.body.style.backgroundRepeat = "no-repeat";
  document.body.style.backgroundAttachment = "fixed";
  document.body.style.backgroundSize = "100% 100%";
